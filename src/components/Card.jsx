...
function GroupExample() {
  return (
    <CardGroup className="cardgroup">
      <Card>
        <Card.Img id="imgcard" variant="top" src="./images/portfolio1.jpg" />
        <Card.Body>
          <h5>Fresh food</h5>
      ...
      <Card>
        <Card.Img id="imgcard" variant="top" src="./images/portfolio2.jpg" />
        <Card.Body>
      ...
      <Card>
        <Card.Img id="imgcard" variant="top" src="./images/portfolio3.jpg" />
        <Card.Body>
