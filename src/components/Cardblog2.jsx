...
function GroupExample() {
  return (
    <CardGroup>
      <Card>
        <Card.Img id="imgcard" variant="top" src="./images/blogimg4.jpg" />
        <Card.Body>
      ...
      <Card>
        <Card.Img id="imgcard" variant="top" src="./images/blogimg5.jpg" />
        <Card.Body>
      ...
      <Card>
        <Card.Img id="imgcard" variant="top" src="./images/blogimg6.jpg" />
        <Card.Body>
